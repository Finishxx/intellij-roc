...
public class RocLiteralPatternImpl extends ASTWrapperPsiElement implements RocLiteralPattern {

  public RocLiteralPatternImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PsiElement getSingleQuote() {
    return findChildByType(SINGLE_QUOTE);
  }
