...
public class RocTagUnionExtImpl extends ASTWrapperPsiElement implements RocTagUnionExt {

  public RocTagUnionExtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RocVisitor visitor) {
    visitor.visitTagUnionExt(this);
  }
