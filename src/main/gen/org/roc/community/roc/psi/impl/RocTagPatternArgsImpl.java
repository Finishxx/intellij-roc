...
public class RocTagPatternArgsImpl extends ASTWrapperPsiElement implements RocTagPatternArgs {

  public RocTagPatternArgsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RocVisitor visitor) {
    visitor.visitTagPatternArgs(this);
  }
