...
public class RocListPatternImpl extends ASTWrapperPsiElement implements RocListPattern {

  public RocListPatternImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<RocListRestPattern> getListRestPatternList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, RocListRestPattern.class);
  }
