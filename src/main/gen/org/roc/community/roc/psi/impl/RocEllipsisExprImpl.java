...
public class RocEllipsisExprImpl extends RocExprImpl implements RocEllipsisExpr {

  public RocEllipsisExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull RocVisitor visitor) {
    visitor.visitEllipsisExpr(this);
  }
