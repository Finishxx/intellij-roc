...
public class RocInferredTypeVarImpl extends ASTWrapperPsiElement implements RocInferredTypeVar {

  public RocInferredTypeVarImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RocVisitor visitor) {
    visitor.visitInferredTypeVar(this);
  }
  ...
  public PsiElement getNamedUnderscore() {
    return findNotNullChildByType(NAMED_UNDERSCORE);
  }
