...
public class RocExpectStmtImpl extends ASTWrapperPsiElement implements RocExpectStmt {

  public RocExpectStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RocVisitor visitor) {
    visitor.visitExpectStmt(this);
  }
