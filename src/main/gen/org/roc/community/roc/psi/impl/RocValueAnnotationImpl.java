...
public class RocValueAnnotationImpl extends ASTWrapperPsiElement implements RocValueAnnotation {

  public RocValueAnnotationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RocVisitor visitor) {
    visitor.visitValueAnnotation(this);
  }
