...
public class RocAlternativesPatternImpl extends ASTWrapperPsiElement implements RocAlternativesPattern {

  public RocAlternativesPatternImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RocVisitor visitor) {
    visitor.visitAlternativesPattern(this);
  }
