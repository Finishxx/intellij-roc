...
public class RocUnderscorePatternImpl extends ASTWrapperPsiElement implements RocUnderscorePattern {

  public RocUnderscorePatternImpl(@NotNull ASTNode node) {
    super(node);
  }
