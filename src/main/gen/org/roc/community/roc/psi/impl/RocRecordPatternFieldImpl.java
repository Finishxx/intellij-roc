...
public class RocRecordPatternFieldImpl extends ASTWrapperPsiElement implements RocRecordPatternField {

  public RocRecordPatternFieldImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RocVisitor visitor) {
    visitor.visitRecordPatternField(this);
  }
  ...
  @Override
  @Nullable
  public RocAlternativesPattern getAlternativesPattern() {
    return findChildByClass(RocAlternativesPattern.class);
  }
