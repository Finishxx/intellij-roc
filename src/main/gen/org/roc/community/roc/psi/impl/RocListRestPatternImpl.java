...
public class RocListRestPatternImpl extends ASTWrapperPsiElement implements RocListRestPattern {

  public RocListRestPatternImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RocVisitor visitor) {
    visitor.visitListRestPattern(this);
  }
