...
public class RocArrowCallExprImpl extends RocExprImpl implements RocArrowCallExpr {

  public RocArrowCallExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull RocVisitor visitor) {
    visitor.visitArrowCallExpr(this);
  }
