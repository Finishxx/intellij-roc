...
public class RocCrashStmtImpl extends ASTWrapperPsiElement implements RocCrashStmt {

  public RocCrashStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RocVisitor visitor) {
    visitor.visitCrashStmt(this);
  }
