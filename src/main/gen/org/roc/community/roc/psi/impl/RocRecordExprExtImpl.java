...
public class RocRecordExprExtImpl extends ASTWrapperPsiElement implements RocRecordExprExt {

  public RocRecordExprExtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RocVisitor visitor) {
    visitor.visitRecordExprExt(this);
  }
