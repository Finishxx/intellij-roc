...
public class RocExposedItemImpl extends ASTWrapperPsiElement implements RocExposedItem {

  public RocExposedItemImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RocVisitor visitor) {
    visitor.visitExposedItem(this);
  }
