...
public class RocPackagesImpl extends ASTWrapperPsiElement implements RocPackages {

  public RocPackagesImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<RocPackageEntry> getPackageEntryList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, RocPackageEntry.class);
  }
