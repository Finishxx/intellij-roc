...
public class RocRecordExprFieldImpl extends ASTWrapperPsiElement implements RocRecordExprField {

  public RocRecordExprFieldImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RocVisitor visitor) {
    visitor.visitRecordExprField(this);
  }
