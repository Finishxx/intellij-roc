...
public class RocTypeDeclImpl extends ASTWrapperPsiElement implements RocTypeDecl {

  public RocTypeDeclImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public RocTypeHeader getTypeHeader() {
    return findNotNullChildByClass(RocTypeHeader.class);
  }
  ...
  @Override
  @Nullable
  public RocWhereClause getWhereClause() {
    return findChildByClass(RocWhereClause.class);
  }
