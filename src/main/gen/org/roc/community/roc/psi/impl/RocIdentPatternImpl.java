...
public class RocIdentPatternImpl extends ASTWrapperPsiElement implements RocIdentPattern {

  public RocIdentPatternImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RocVisitor visitor) {
    visitor.visitIdentPattern(this);
  }
