...
public class RocRequiresForAliasImpl extends ASTWrapperPsiElement implements RocRequiresForAlias {

  public RocRequiresForAliasImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RocVisitor visitor) {
    visitor.visitRequiresForAlias(this);
  }
