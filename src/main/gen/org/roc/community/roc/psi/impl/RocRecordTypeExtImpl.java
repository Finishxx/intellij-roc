...
public class RocRecordTypeExtImpl extends ASTWrapperPsiElement implements RocRecordTypeExt {

  public RocRecordTypeExtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RocVisitor visitor) {
    visitor.visitRecordTypeExt(this);
  }
