...
public class RocAppHeaderImpl extends ASTWrapperPsiElement implements RocAppHeader {

  public RocAppHeaderImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public RocProvides getProvides() {
    return findNotNullChildByClass(RocProvides.class);
  }
