...
public class RocMatchExprImpl extends RocExprImpl implements RocMatchExpr {

  public RocMatchExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<RocMatchBranch> getMatchBranchList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, RocMatchBranch.class);
  }
