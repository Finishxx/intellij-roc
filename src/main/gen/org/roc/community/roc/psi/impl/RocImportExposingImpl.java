...
public class RocImportExposingImpl extends ASTWrapperPsiElement implements RocImportExposing {

  public RocImportExposingImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RocVisitor visitor) {
    visitor.visitImportExposing(this);
  }
